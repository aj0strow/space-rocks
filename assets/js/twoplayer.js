    ...
    var game = {
      ...
      start: function() {                                                                                                                                                                                                                
        if(this.lives > 3) {
          ...
          console.log("You've lost but you can use the secondplayer's lives");
          console.log("your current score is: " + this.totalScore);
          this.secondPlayer();
      ...
      secondPlayer: function(){
        console.log("Now switch to Player 2");
        if(this.lives > 0) {
          var Ship = window.SpaceRocks.Ship;
          var Asteroid = window.SpaceRocks.Asteroid;
          ...
          console.log("You've used up both players' lives");
